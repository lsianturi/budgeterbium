  ...
  <div id="budget-create-edit-view">
    ...
    <div class="columns">
      <div class="column is-6">
        <form clas="form" @submit.prevent="processSave">
          ...
          <span class="help" v-if="!editing">To add budget items you must first save budget</span>
        ...
        <tbody>
          ...
          >
            <component
              ...
              v-on:edit-budget-category="activeBudgetCategory = selectedBudget.budgetCategories[key]"
            ></component>
          </template>
          ...
          <tr>
            <td>
              ...
              <select class="select" @change="processDuplicateBudget($event.target.value)">
                <option v-for="value, key in sortedBudgets"
                  :value="value.id">
                  {{ value.month | moment }}
                </option>
              </select>
