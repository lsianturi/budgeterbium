...
export default {
  ...
  methods: {
    ...
    updateCategorySelection (category) {
      // if using v-model and using Vue.set directly, vue-multiselect seems to struggle ro properly
      // keep its internal value to date with the value in our component. So we're skipping v-model
