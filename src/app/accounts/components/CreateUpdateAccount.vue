<template>
  <div id='account-create-edit-view'>
    <nav class="level">
      ...
      <div class="column is-6">
        <form class="form" @submit.prevent="processSave">
          ...
          <p class="control has-icon" v-if="!editing">
            ...
            <span class="help">Use a negative values for account that caary a negative balance, e.g. credit cards</span>
            <span class="icon">
              <i class="fa fa-usd" aria-hidden="true"></i>
            </span>
          </p>
          <p v-else>
            <span>To update your balance, add a balance addjusting transaction</span>
          </p>
